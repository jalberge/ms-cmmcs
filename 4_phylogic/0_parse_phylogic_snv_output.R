...
# write_tsv(ldfr.fixed.protein.change, "../data/phylogic_aggregation_snv_Feb14.tsv")
write_tsv(ldfr.fixed.protein.change.matched, "../data/phylogic_aggregation_snv_Mar14.tsv")
