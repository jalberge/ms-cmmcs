...
![](3_matched_CNV_tx_files/figure-html/unnamed-chunk-6-1.png)<!-- -->

```r
ggsave(full.plot, filename = "figures/fig2-cnv-ig.png", width = 7, height = 3)
ggsave(full.plot, filename = "figures/fig2-cnv-ig.pdf", width = 7, height = 3)
```
...
[31] highr_0.9           dbplyr_2.1.1        rlang_0.4.11       
[34] GlobalOptions_0.1.2 rstudioapi_0.13     farver_2.1.0       
[37] shape_1.4.6         jquerylib_0.1.4     generics_0.1.0     
[40] jsonlite_1.7.2      vroom_1.5.4         zip_2.2.0          
[43] car_3.0-11          magrittr_2.0.1      Matrix_1.3-4       
[46] Rcpp_1.0.7          munsell_0.5.0       fansi_0.5.0        
[49] abind_1.4-5         lifecycle_1.0.0     stringi_1.7.3      
[52] yaml_2.2.1          carData_3.0-4       grid_4.1.1         
[55] parallel_4.1.1      crayon_1.4.1        lattice_0.20-44    
[58] haven_2.4.3         splines_4.1.1       hms_1.1.0          
[61] knitr_1.33          pillar_1.6.2        ggsignif_0.6.2     
...
[73] xfun_0.25           openxlsx_4.2.4      broom_0.7.9        
[76] survival_3.2-12     viridisLite_0.4.0   ellipsis_0.3.2     
```
